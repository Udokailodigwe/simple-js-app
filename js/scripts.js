...
const pokemonRepository = (function(){
   ...
   function addListItem(pokemon){
      ...
      pokemonListItems.classList.add('group-list-item', 'col-12', 'col-md-4', 'col-lg-3'); //Added bootstrap components to created list tag.

      let pokemonButton = document.createElement('button'); 
      pokemonButton.innerText = pokemon.name ; 
      pokemonButton.classList.add('btn', 'btn-info', 'btn-block', 'btn-md', 'button-class'); //Added button utility classes to created button
